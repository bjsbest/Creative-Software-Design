...
class Moon: public Planet {
    public:
        ...
        void simulate(float height); // Print out information about this object (ex. ' Moon gravity = 1.62') and the result of drop simulation(‘Drop from 30m, 6.08581 seconds.’).
};